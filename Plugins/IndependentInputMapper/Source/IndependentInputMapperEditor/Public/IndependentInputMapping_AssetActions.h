...
#include "IndependentInputMapping_AssetActions.generated.h"
 ...
 */
UCLASS()
class INDEPENDENTINPUTMAPPEREDITOR_API UInputKeyVisualCollection_Factory : public UFactory
{
	GENERATED_UCLASS_BODY()
 ...
 *
 */
class INDEPENDENTINPUTMAPPEREDITOR_API FAssetTypeActions_InputKeyVisualCollection : public FAssetTypeActions_DataAsset
{
public:
	...
	virtual FText GetName() const override;
	virtual uint32 GetCategories() override;
	virtual FColor GetTypeColor() const override { return FColor(64, 192, 64, 255); }
	virtual FText GetAssetDescription(const FAssetData& AssetData) const override;
	virtual UClass* GetSupportedClass() const override;
	virtual const FSlateBrush* GetThumbnailBrush(const FAssetData& InAssetData, const FName InClassName) const override;
	virtual const FSlateBrush* GetIconBrush(const FAssetData& InAssetData, const FName InClassName) const override;
